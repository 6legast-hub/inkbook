...
export const SAMPLE_MASTER: MasterProfile = {
  ...
  bio: "Работаю в стилях fine-line, блэкворк и орнаментал. Каждый эскиз — индивидуально под клиента, без флэша из каталога. Стерильность, аккуратность и спокойная атмосфера в студии.",
